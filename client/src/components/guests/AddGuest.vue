      ...
      <q-card-section style="flex: 1; max-height: 70vh; overflow: auto;">
        <q-form no-error-focus>
          <div class="inputs-container row q-col-gutter-md">
            ...
            <q-input standout="bg-secondary text-white" v-model="illnessesInput" label="Illnesses" />
            
            <q-input standout="bg-secondary text-white" v-model="medicationsInput" label="Medications" />
